...
$HoloStitcher = {
    ...
    if ($resolution -eq 1080) {
        ffmpeg -f lavfi -i color=black:s=1920x1080:r=30000/1000 -f lavfi -i anullsrc -ar 48000 -ac 2 -t 3 blackscreen.mkv
    }
    if ($resolution -eq 720) {
        ffmpeg -f lavfi -i color=black:s=1280x720:r=30000/1000 -f lavfi -i anullsrc -ar 48000 -ac 2 -t 3 blackscreen.mkv
    }
    if ($resolution -eq 480) {
        ffmpeg -f lavfi -i color=black:s=854x480:r=30000/1000 -f lavfi -i anullsrc -ar 48000 -ac 2 -t 3 blackscreen.mkv
    }
    if ($resolution -eq 360) {
        ffmpeg -f lavfi -i color=black:s=640x360:r=30000/1000 -f lavfi -i anullsrc -ar 48000 -ac 2 -t 3 blackscreen.mkv
    }
    ...
    if ($vidcount -eq 2) {
        ffmpeg -i ".\originals\clip1.mkv" -i blackscreen.mkv -i ".\originals\clip2.mkv" -filter_complex "[0:v:0][0:a:0][1:v:0][1:a:0][2:v:0][2:a:0]concat=n=3:v=1:a=1[outv][outa]" -map "[outv]" -map "[outa]" -x264-params keyint=24:min-keyint=1 "clip$fulltitle.mkv"
    }
    if ($vidcount -eq 3) {
        ffmpeg -i ".\originals\clip1.mkv" -i blackscreen.mkv -i ".\originals\clip2.mkv" -i blackscreen.mkv -i ".\originals\clip3.mkv" -filter_complex "[0:v:0][0:a:0][1:v:0][1:a:0][2:v:0][2:a:0][3:v:0][3:a:0][4:v:0][4:a:0]concat=n=5:v=1:a=1[outv][outa]" -map "[outv]" -map "[outa]" -x264-params keyint=24:min-keyint=1 "clip$fulltitle.mkv"
    }
    if ($vidcount -eq 4) {
        ffmpeg -i ".\originals\clip1.mkv" -i blackscreen.mkv -i ".\originals\clip2.mkv" -i blackscreen.mkv -i ".\originals\clip3.mkv" -i blackscreen.mkv -i ".\originals\clip4.mkv" -filter_complex "[0:v:0][0:a:0][1:v:0][1:a:0][2:v:0][2:a:0][3:v:0][3:a:0][4:v:0][4:a:0][5:v:0][5:a:0][6:v:0][6:a:0]concat=n=7:v=1:a=1[outv][outa]" -map "[outv]" -map "[outa]" -x264-params keyint=24:min-keyint=1 "clip$fulltitle.mkv"
    }
    if ($vidcount -eq 5) {
        ffmpeg -i ".\originals\clip1.mkv" -i blackscreen.mkv -i ".\originals\clip2.mkv" -i blackscreen.mkv -i ".\originals\clip3.mkv" -i blackscreen.mkv -i ".\originals\clip4.mkv" -i blackscreen.mkv -i ".\originals\clip5.mkv" -filter_complex "[0:v:0][0:a:0][1:v:0][1:a:0][2:v:0][2:a:0][3:v:0][3:a:0][4:v:0][4:a:0][5:v:0][5:a:0][6:v:0][6:a:0][7:v:0][7:a:0][8:v:0][8:a:0]concat=n=9:v=1:a=1[outv][outa]" -map "[outv]" -map "[outa]" -x264-params keyint=24:min-keyint=1 "clip$fulltitle.mkv"
    }
    if ($vidcount -eq 6) {
        ffmpeg -i ".\originals\clip1.mkv" -i blackscreen.mkv -i ".\originals\clip2.mkv" -i blackscreen.mkv -i ".\originals\clip3.mkv" -i blackscreen.mkv -i ".\originals\clip4.mkv" -i blackscreen.mkv -i ".\originals\clip5.mkv" -i blackscreen.mkv -i ".\originals\clip6.mkv" -filter_complex "[0:v:0][0:a:0][1:v:0][1:a:0][2:v:0][2:a:0][3:v:0][3:a:0][4:v:0][4:a:0][5:v:0][5:a:0][6:v:0][6:a:0][7:v:0][7:a:0][8:v:0][8:a:0][9:v:0][9:a:0][10:v:0][10:a:0]concat=n=11:v=1:a=1[outv][outa]" -map "[outv]" -map "[outa]" -x264-params keyint=24:min-keyint=1 "clip$fulltitle.mkv"
    }
    if ($vidcount -eq 7) {
        ffmpeg -i ".\originals\clip1.mkv" -i blackscreen.mkv -i ".\originals\clip2.mkv" -i blackscreen.mkv -i ".\originals\clip3.mkv" -i blackscreen.mkv -i ".\originals\clip4.mkv" -i blackscreen.mkv -i ".\originals\clip5.mkv" -i blackscreen.mkv -i ".\originals\clip6.mkv" -i blackscreen.mkv -i ".\originals\clip7.mkv" -filter_complex "[0:v:0][0:a:0][1:v:0][1:a:0][2:v:0][2:a:0][3:v:0][3:a:0][4:v:0][4:a:0][5:v:0][5:a:0][6:v:0][6:a:0][7:v:0][7:a:0][8:v:0][8:a:0][9:v:0][9:a:0][10:v:0][10:a:0][11:v:0][11:a:0][12:v:0][12:a:0]concat=n=13:v=1:a=1[outv][outa]" -map "[outv]" -map "[outa]" -x264-params keyint=24:min-keyint=1 "clip$fulltitle.mkv"
    }
    if ($vidcount -eq 8) {
        ffmpeg -i ".\originals\clip1.mkv" -i blackscreen.mkv -i ".\originals\clip2.mkv" -i blackscreen.mkv -i ".\originals\clip3.mkv" -i blackscreen.mkv -i ".\originals\clip4.mkv" -i blackscreen.mkv -i ".\originals\clip5.mkv" -i blackscreen.mkv -i ".\originals\clip6.mkv" -i blackscreen.mkv -i ".\originals\clip7.mkv" -i blackscreen.mkv -i ".\originals\clip8.mkv" -filter_complex "[0:v:0][0:a:0][1:v:0][1:a:0][2:v:0][2:a:0][3:v:0][3:a:0][4:v:0][4:a:0][5:v:0][5:a:0][6:v:0][6:a:0][7:v:0][7:a:0][8:v:0][8:a:0][9:v:0][9:a:0][10:v:0][10:a:0][11:v:0][11:a:0][12:v:0][12:a:0][13:v:0][13:a:0][14:v:0][14:a:0]concat=n=15:v=1:a=1[outv][outa]" -map "[outv]" -map "[outa]" -x264-params keyint=24:min-keyint=1 "clip$fulltitle.mkv"
    }
    if ($vidcount -eq 9) {
        ffmpeg -i ".\originals\clip1.mkv" -i blackscreen.mkv -i ".\originals\clip2.mkv" -i blackscreen.mkv -i ".\originals\clip3.mkv" -i blackscreen.mkv -i ".\originals\clip4.mkv" -i blackscreen.mkv -i ".\originals\clip5.mkv" -i blackscreen.mkv -i ".\originals\clip6.mkv" -i blackscreen.mkv -i ".\originals\clip7.mkv" -i blackscreen.mkv -i ".\originals\clip8.mkv" -i blackscreen.mkv -i ".\originals\clip9.mkv" -filter_complex "[0:v:0][0:a:0][1:v:0][1:a:0][2:v:0][2:a:0][3:v:0][3:a:0][4:v:0][4:a:0][5:v:0][5:a:0][6:v:0][6:a:0][7:v:0][7:a:0][8:v:0][8:a:0][9:v:0][9:a:0][10:v:0][10:a:0][11:v:0][11:a:0][12:v:0][12:a:0][13:v:0][13:a:0][14:v:0][14:a:0][15:v:0][15:a:0][16:v:0][16:a:0]concat=n=17:v=1:a=1[outv][outa]" -map "[outv]" -map "[outa]" -x264-params keyint=24:min-keyint=1 "clip$fulltitle.mkv"
    }
    if ($vidcount -eq 10) {
        ffmpeg -i ".\originals\clip1.mkv" -i blackscreen.mkv -i ".\originals\clip2.mkv" -i blackscreen.mkv -i ".\originals\clip3.mkv" -i blackscreen.mkv -i ".\originals\clip4.mkv" -i blackscreen.mkv -i ".\originals\clip5.mkv" -i blackscreen.mkv -i ".\originals\clip6.mkv" -i blackscreen.mkv -i ".\originals\clip7.mkv" -i blackscreen.mkv -i ".\originals\clip8.mkv" -i blackscreen.mkv -i ".\originals\clip9.mkv" -i blackscreen.mkv -i ".\originals\clip10.mkv" -filter_complex "[0:v:0][0:a:0][1:v:0][1:a:0][2:v:0][2:a:0][3:v:0][3:a:0][4:v:0][4:a:0][5:v:0][5:a:0][6:v:0][6:a:0][7:v:0][7:a:0][8:v:0][8:a:0][9:v:0][9:a:0][10:v:0][10:a:0][11:v:0][11:a:0][12:v:0][12:a:0][13:v:0][13:a:0][14:v:0][14:a:0][15:v:0][15:a:0][16:v:0][16:a:0][17:v:0][17:a:0][18:v:0][18:a:0]concat=n=19:v=1:a=1[outv][outa]" -map "[outv]" -map "[outa]" -x264-params keyint=24:min-keyint=1 "clip$fulltitle.mkv"
    }
    if ($vidcount -gt 10) {
    ...
    if ($videotype -eq "A" -or $videotype -eq "a") {
        ...
        if ($miniclip -eq "Y" -or $miniclip -eq "y") {
            ...
            if ($miniclipnum -eq 2) {
                ...
                #this constructs the two timestamps used in the ffmpeg command
                ...
                ffmpeg -ss $clip1Sps -i ($glink1) -t $clip1Rt -ss $clip1Sps -i ($glink2) -t $clip1Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip2Sps -i ($glink1) -t $clip2Rt -ss $clip2Sps -i ($glink2) -t $clip2Rt "clip$clipnum.mkv"
            ...
            if ($miniclipnum -eq 3) {
                ...
                ffmpeg -ss $clip2Sps -i ($glink1) -t $clip2Rt -ss $clip2Sps -i ($glink2) -t $clip2Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip3Sps -i ($glink1) -t $clip3Rt -ss $clip3Sps -i ($glink2) -t $clip3Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 4) {
                ...
                ffmpeg -ss $clip3Sps -i ($glink1) -t $clip3Rt -ss $clip3Sps -i ($glink2) -t $clip3Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip4Sps -i ($glink1) -t $clip4Rt -ss $clip4Sps -i ($glink2) -t $clip4Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 5) {
                ...
                ffmpeg -ss $clip4Sps -i ($glink1) -t $clip4Rt -ss $clip4Sps -i ($glink2) -t $clip4Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip5Sps -i ($glink1) -t $clip5Rt -ss $clip5Sps -i ($glink2) -t $clip5Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 6) {
                ...
                ffmpeg -ss $clip5Sps -i ($glink1) -t $clip5Rt -ss $clip5Sps -i ($glink2) -t $clip5Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip6Sps -i ($glink1) -t $clip6Rt -ss $clip6Sps -i ($glink2) -t $clip6Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 7) {
                ...
                ffmpeg -ss $clip6Sps -i ($glink1) -t $clip6Rt -ss $clip6Sps -i ($glink2) -t $clip6Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip7Sps -i ($glink1) -t $clip7Rt -ss $clip7Sps -i ($glink2) -t $clip7Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 8) {
                ...
                ffmpeg -ss $clip7Sps -i ($glink1) -t $clip7Rt -ss $clip7Sps -i ($glink2) -t $clip7Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip8Sps -i ($glink1) -t $clip8Rt -ss $clip8Sps -i ($glink2) -t $clip8Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 9) {
                ...
                ffmpeg -ss $clip8Sps -i ($glink1) -t $clip8Rt -ss $clip8Sps -i ($glink2) -t $clip8Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip9Sps -i ($glink1) -t $clip9Rt -ss $clip9Sps -i ($glink2) -t $clip9Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 10) {
                ...
                ffmpeg -ss $clip9Sps -i ($glink1) -t $clip9Rt -ss $clip9Sps -i ($glink2) -t $clip9Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip10Sps -i ($glink1) -t $clip10Rt -ss $clip10Sps -i ($glink2) -t $clip10Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
        ...
        $glink1,$glink2 = $glinks.split(" ")
        if (!$glink2) {$glink2 = $glink1}
        ffmpeg -ss $timestampSps -i ($glink1) -t $timestampEps -ss $timestampSps -i ($glink2) -t $timestampEps "clip$clipnum.mkv"
        }
    }
    ...
    if ($videotype -eq "B" -or $videotype -eq "b") {
        ...
        if ($miniclip -eq "Y" -or $miniclip -eq "y") {
            ...
            if ($miniclipnum -eq 2) {
                ...
                ffmpeg -ss $clip1Sps -i ($glink) -t $clip1Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip2Sps -i ($glink) -t $clip2Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 3) {
                ...
                ffmpeg -ss $clip2Sps -i ($glink) -t $clip2Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip3Sps -i ($glink) -t $clip3Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 4) {
                ...
                ffmpeg -ss $clip3Sps -i ($glink) -t $clip3Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip4Sps -i ($glink) -t $clip4Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 5) {
                ...
                ffmpeg -ss $clip4Sps -i ($glink) -t $clip4Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip5Sps -i ($glink) -t $clip5Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 6) {
                ...
                ffmpeg -ss $clip5Sps -i ($glink) -t $clip5Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip6Sps -i ($glink) -t $clip6Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 7) {
                ...
                ffmpeg -ss $clip6Sps -i ($glink) -t $clip6Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip7Sps -i ($glink) -t $clip7Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 8) {
                ...
                ffmpeg -ss $clip7Sps -i ($glink) -t $clip7Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip8Sps -i ($glink) -t $clip8Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 9) {
                ...
                ffmpeg -ss $clip8Sps -i ($glink) -t $clip8Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip9Sps -i ($glink) -t $clip9Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
            ...
            if ($miniclipnum -eq 10) {
                ...
                ffmpeg -ss $clip9Sps -i ($glink) -t $clip9Rt "clip$clipnum.mkv"
                $clipnum = $clipnum + 1
                ffmpeg -ss $clip10Sps -i ($glink) -t $clip10Rt "clip$clipnum.mkv"
                $needsstitching = read-host -prompt 'Do you want to stitch clips? [Y/N]'
                if ($needsstitching -eq "Y" -or $needsstitching -eq "y") {
                   &$HoloStitcher
                }
        ...
        $glink = youtube-dl -g "$inlink"
        while (!$glink) {$glink = youtube-dl -g "$inlink"}
        ffmpeg -ss $timestampSps -i ($glink) -t $timestampEps "clip$clipnum.mkv"
        }
    }
    ...
    if ($videotype -eq "C" -or $videotype -eq "c") {
        ...
        if ($miniclip -eq "Y" -or $miniclip -eq "y") {
            ...
            for ($miniclipnum -gt 0; $miniclipnum--) {
                ffmpeg -ss $timestampSps -i $tempFile -t $timestampEps -c copy "clip$clipnum.mkv"
                $timestampSin = read-host -prompt "Input Start Time (Format: XX:XX:XX:XX)"
                $ts1,$ts2,$ts3,$ts4 = $timestampSin.split(":")
                $ts1 = [int]$ts1
                $ts2 = [int]$ts2
